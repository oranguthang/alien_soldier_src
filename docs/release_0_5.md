...
- Naming/evidence rules, 14,885 provenance mappings, and the remaining 1,166
...
The contract does not require invented semantics. The 1,166 address-derived
definitions in the current backlog comprise 831 RAM equates, 335 preserved-
data definitions, and no executable-source definitions. The exact-address
audit registry contains 12,094 records. A further 3,091 provenance-mapped
...
be folded into one record. It includes 400 reviewed asset `_End` aliases that
