...
- Naming/evidence rules, 15,509 provenance mappings, and the remaining 542
...
The contract does not require invented semantics. The 542 address-derived
...
audit registry contains 12,659 records. A further 3,150 provenance-mapped
