...
- Naming/evidence rules, 15,847 provenance mappings, and the remaining 204
...
The contract does not require invented semantics. The 204 address-derived
...
audit registry contains 13,012 records. A further 3,135 provenance-mapped
