...
address audit registry contains 13,327 records. A further 3,016 provenance-mapped
...
upper bound is 2,503 names; no other pending `_End` labels are hidden by that
