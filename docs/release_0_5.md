...
address audit registry contains 14,130 records. A further 2,212 provenance-mapped
...
upper bound is 1,699 names; no other pending `_End` labels are hidden by that
