...
- Naming/evidence rules, 15,319 provenance mappings, and the remaining 732
...
The contract does not require invented semantics. The 732 address-derived
...
audit registry contains 12,449 records. A further 3,170 provenance-mapped
