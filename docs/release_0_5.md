...
address audit registry contains 13,403 records. A further 2,940 provenance-mapped
...
upper bound is 2,427 names; no other pending `_End` labels are hidden by that
