...
address audit registry contains 15,544 records. A further 800 provenance-mapped
...
upper bound is 287 names; no other pending `_End` labels are hidden by that
