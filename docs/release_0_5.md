...
address audit registry contains 13,693 records. A further 2,649 provenance-mapped
...
upper bound is 2,136 names; no other pending `_End` labels are hidden by that
