...
address audit registry contains 13,374 records. A further 2,969 provenance-mapped
...
upper bound is 2,456 names; no other pending `_End` labels are hidden by that
