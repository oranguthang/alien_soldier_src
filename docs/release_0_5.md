...
- Naming/evidence rules, 12,142 provenance mappings, and the remaining 3,899
...
3,899 address-derived definitions intentionally remain in the unknowns backlog.
