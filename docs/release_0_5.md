...
- `src/main.s` is an address-ordered index over 396 modules with a checked
  1,000-line ceiling; the current mean is 300.3 lines, the largest module is
  878 lines, and no waiver is active.
