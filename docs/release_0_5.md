...
address audit registry contains 15,297 records. A further 1,047 provenance-mapped
...
upper bound is 534 names; no other pending `_End` labels are hidden by that
