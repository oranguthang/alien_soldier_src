...
address audit registry contains 15,177 records. A further 1,165 provenance-mapped
...
upper bound is 652 names; no other pending `_End` labels are hidden by that
