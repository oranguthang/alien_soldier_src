...
address audit registry contains 14,097 records. A further 2,245 provenance-mapped
...
upper bound is 1,732 names; no other pending `_End` labels are hidden by that
