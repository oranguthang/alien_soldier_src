...
address audit registry contains 15,236 records. A further 1,106 provenance-mapped
...
upper bound is 593 names; no other pending `_End` labels are hidden by that
