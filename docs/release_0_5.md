...
- Naming/evidence rules, 13,345 provenance mappings, and the remaining 2,703
...
2,703 address-derived definitions intentionally remain in the unknowns backlog.
