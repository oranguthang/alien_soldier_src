...
- Naming/evidence rules, 14,962 provenance mappings, and the remaining 1,089
...
The contract does not require invented semantics. The 1,089 address-derived
definitions in the current backlog comprise 831 RAM equates, 258 preserved-
data definitions, and no executable-source definitions. The exact-address
audit registry contains 12,158 records. A further 3,104 provenance-mapped
...
be folded into one record. It includes 418 reviewed asset `_End` aliases that
