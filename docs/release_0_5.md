...
address audit registry contains 13,610 records. A further 2,732 provenance-mapped
...
upper bound is 2,219 names; no other pending `_End` labels are hidden by that
