...
address audit registry contains 14,665 records. A further 1,677 provenance-mapped
...
upper bound is 1,164 names; no other pending `_End` labels are hidden by that
