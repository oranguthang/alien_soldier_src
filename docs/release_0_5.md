...
address audit registry contains 15,064 records. A further 1,278 provenance-mapped
...
upper bound is 765 names; no other pending `_End` labels are hidden by that
