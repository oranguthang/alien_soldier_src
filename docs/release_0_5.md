...
- Naming/evidence rules, 12,351 provenance mappings, and the remaining 3,690
...
3,690 address-derived definitions intentionally remain in the unknowns backlog.
