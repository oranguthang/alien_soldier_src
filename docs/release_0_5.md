...
- Naming/evidence rules, 12,596 provenance mappings, and the remaining 3,451
...
3,451 address-derived definitions intentionally remain in the unknowns backlog.
