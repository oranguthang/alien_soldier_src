...
address audit registry contains 13,872 records. A further 2,470 provenance-mapped
...
upper bound is 1,957 names; no other pending `_End` labels are hidden by that
