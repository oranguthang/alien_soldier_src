...
address audit registry contains 14,380 records. A further 1,962 provenance-mapped
...
upper bound is 1,449 names; no other pending `_End` labels are hidden by that
