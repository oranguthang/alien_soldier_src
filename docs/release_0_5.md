...
- Naming/evidence rules, 15,352 provenance mappings, and the remaining 699
...
The contract does not require invented semantics. The 699 address-derived
...
audit registry contains 12,491 records. A further 3,161 provenance-mapped
