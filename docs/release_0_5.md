...
- Naming/evidence rules, 15,886 provenance mappings, and the remaining 165
...
The contract does not require invented semantics. The 165 address-derived
...
audit registry contains 13,075 records. A further 3,111 provenance-mapped
