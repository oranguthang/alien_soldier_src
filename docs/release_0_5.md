...
- Naming/evidence rules, 12,812 provenance mappings, and the remaining 3,235
...
3,235 address-derived definitions intentionally remain in the unknowns backlog.
