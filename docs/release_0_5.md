...
address audit registry contains 13,915 records. A further 2,427 provenance-mapped
...
upper bound is 1,914 names; no other pending `_End` labels are hidden by that
