...
address audit registry contains 14,903 records. A further 1,439 provenance-mapped
...
upper bound is 926 names; no other pending `_End` labels are hidden by that
