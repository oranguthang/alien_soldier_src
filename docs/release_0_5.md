...
address audit registry contains 13,571 records. A further 2,771 provenance-mapped
...
upper bound is 2,258 names; no other pending `_End` labels are hidden by that
