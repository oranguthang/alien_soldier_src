...
address audit registry contains 15,481 records. A further 863 provenance-mapped
...
upper bound is 350 names; no other pending `_End` labels are hidden by that
