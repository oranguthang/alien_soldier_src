...
address audit registry contains 15,008 records. A further 1,334 provenance-mapped
...
upper bound is 821 names; no other pending `_End` labels are hidden by that
