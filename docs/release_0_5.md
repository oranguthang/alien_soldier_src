...
address audit registry contains 14,011 records. A further 2,331 provenance-mapped
...
upper bound is 1,818 names; no other pending `_End` labels are hidden by that
