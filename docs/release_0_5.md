...
address audit registry contains 15,676 records. A further 668 provenance-mapped
...
upper bound is 155 names; no other pending `_End` labels are hidden by that
