...
address audit registry contains 13,666 records. A further 2,676 provenance-mapped
...
upper bound is 2,163 names; no other pending `_End` labels are hidden by that
