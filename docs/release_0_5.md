...
address audit registry contains 14,417 records. A further 1,925 provenance-mapped
...
upper bound is 1,412 names; no other pending `_End` labels are hidden by that
