...
address audit registry contains 13,493 records. A further 2,849 provenance-mapped
...
upper bound is 2,336 names; no other pending `_End` labels are hidden by that
