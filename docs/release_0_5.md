...
- Naming/evidence rules, 15,348 provenance mappings, and the remaining 703
...
The contract does not require invented semantics. The 703 address-derived
...
audit registry contains 12,485 records. A further 3,163 provenance-mapped
