...
address audit registry contains 15,609 records. A further 735 provenance-mapped
...
upper bound is 222 names; no other pending `_End` labels are hidden by that
