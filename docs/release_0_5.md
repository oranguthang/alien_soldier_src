...
- Naming/evidence rules, 15,586 provenance mappings, and the remaining 465
...
The contract does not require invented semantics. The 465 address-derived
...
audit registry contains 12,736 records. A further 3,150 provenance-mapped
