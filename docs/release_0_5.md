...
- Naming/evidence rules, 15,365 provenance mappings, and the remaining 686
...
The contract does not require invented semantics. The 686 address-derived
...
audit registry contains 12,505 records. A further 3,160 provenance-mapped
