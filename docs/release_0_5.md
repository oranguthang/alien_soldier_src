...
address audit registry contains 14,580 records. A further 1,762 provenance-mapped
...
upper bound is 1,249 names; no other pending `_End` labels are hidden by that
