...
address audit registry contains 13,443 records. A further 2,900 provenance-mapped
...
upper bound is 2,387 names; no other pending `_End` labels are hidden by that
