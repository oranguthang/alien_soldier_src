...
address audit registry contains 14,955 records. A further 1,387 provenance-mapped
...
upper bound is 874 names; no other pending `_End` labels are hidden by that
