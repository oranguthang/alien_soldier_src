...
- Naming/evidence rules, 12,128 provenance mappings, and the remaining 3,913
...
3,913 address-derived definitions intentionally remain in the unknowns backlog.
