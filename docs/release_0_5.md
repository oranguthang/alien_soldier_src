...
address audit registry contains 13,396 records. A further 2,947 provenance-mapped
...
upper bound is 2,434 names; no other pending `_End` labels are hidden by that
