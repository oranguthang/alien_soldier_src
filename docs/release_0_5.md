...
address audit registry contains 15,357 records. A further 987 provenance-mapped
...
upper bound is 474 names; no other pending `_End` labels are hidden by that
