...
address audit registry contains 13,388 records. A further 2,955 provenance-mapped
...
upper bound is 2,442 names; no other pending `_End` labels are hidden by that
