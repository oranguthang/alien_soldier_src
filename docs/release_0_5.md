...
address audit registry contains 13,381 records. A further 2,962 provenance-mapped
...
upper bound is 2,449 names; no other pending `_End` labels are hidden by that
