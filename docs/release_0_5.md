...
address audit registry contains 13,350 records. A further 2,993 provenance-mapped
...
upper bound is 2,480 names; no other pending `_End` labels are hidden by that
