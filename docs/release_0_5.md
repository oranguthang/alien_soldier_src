...
- Naming/evidence rules, 12,590 provenance mappings, and the remaining 3,453
...
- The listing exports 16,057 canonical ROM/RAM/hardware addresses; layout
...
3,453 address-derived definitions intentionally remain in the unknowns backlog.
