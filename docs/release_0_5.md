...
address audit registry contains 13,707 records. A further 2,635 provenance-mapped
...
upper bound is 2,122 names; no other pending `_End` labels are hidden by that
