...
address audit registry contains 13,368 records. A further 2,975 provenance-mapped
...
upper bound is 2,462 names; no other pending `_End` labels are hidden by that
