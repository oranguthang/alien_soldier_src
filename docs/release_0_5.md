...
address audit registry contains 13,680 records. A further 2,662 provenance-mapped
...
upper bound is 2,149 names; no other pending `_End` labels are hidden by that
