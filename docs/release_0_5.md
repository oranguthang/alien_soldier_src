...
address audit registry contains 13,893 records. A further 2,449 provenance-mapped
...
upper bound is 1,936 names; no other pending `_End` labels are hidden by that
