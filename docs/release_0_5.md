...
address audit registry contains 14,067 records. A further 2,275 provenance-mapped
...
upper bound is 1,762 names; no other pending `_End` labels are hidden by that
