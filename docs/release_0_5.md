...
- Naming/evidence rules, 15,962 provenance mappings, and the remaining 89
...
The contract does not require invented semantics. The 89 address-derived
...
audit registry contains 13,167 records. A further 3,095 provenance-mapped
