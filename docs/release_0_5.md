...
- `src/main.s` is an address-ordered index over 395 modules with a checked
  1,000-line ceiling; the current mean is 301.1 lines, the largest module is
  887 lines, and no waiver is active.
