...
address audit registry contains 13,961 records. A further 2,381 provenance-mapped
...
upper bound is 1,868 names; no other pending `_End` labels are hidden by that
