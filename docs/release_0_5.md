...
address audit registry contains 14,852 records. A further 1,490 provenance-mapped
...
upper bound is 977 names; no other pending `_End` labels are hidden by that
