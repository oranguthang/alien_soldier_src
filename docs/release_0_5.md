...
address audit registry contains 13,345 records. A further 2,998 provenance-mapped
...
upper bound is 2,485 names; no other pending `_End` labels are hidden by that
