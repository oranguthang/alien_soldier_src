...
address audit registry contains 15,419 records. A further 925 provenance-mapped
...
upper bound is 412 names; no other pending `_End` labels are hidden by that
