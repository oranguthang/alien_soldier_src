...
- Naming/evidence rules, 12,066 provenance mappings, and the remaining 3,975
...
3,975 address-derived definitions intentionally remain in the unknowns backlog.
