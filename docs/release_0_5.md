...
address audit registry contains 13,851 records. A further 2,491 provenance-mapped
...
upper bound is 1,978 names; no other pending `_End` labels are hidden by that
