...
- Naming/evidence rules, 12,764 provenance mappings, and the remaining 3,283
...
3,283 address-derived definitions intentionally remain in the unknowns backlog.
