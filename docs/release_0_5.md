...
address audit registry contains 13,773 records. A further 2,569 provenance-mapped
...
upper bound is 2,056 names; no other pending `_End` labels are hidden by that
