...
address audit registry contains 13,419 records. A further 2,924 provenance-mapped
...
upper bound is 2,411 names; no other pending `_End` labels are hidden by that
