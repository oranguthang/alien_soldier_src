...
address audit registry contains 14,269 records. A further 2,073 provenance-mapped
...
upper bound is 1,560 names; no other pending `_End` labels are hidden by that
