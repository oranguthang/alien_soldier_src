...
- Naming/evidence rules, 13,168 provenance mappings, and the remaining 2,880
...
2,880 address-derived definitions intentionally remain in the unknowns backlog.
