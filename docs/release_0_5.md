...
- Naming/evidence rules, 12,203 provenance mappings, and the remaining 3,838
...
3,838 address-derived definitions intentionally remain in the unknowns backlog.
