...
address audit registry contains 14,197 records. A further 2,145 provenance-mapped
...
upper bound is 1,632 names; no other pending `_End` labels are hidden by that
