...
address audit registry contains 14,709 records. A further 1,633 provenance-mapped
...
upper bound is 1,120 names; no other pending `_End` labels are hidden by that
