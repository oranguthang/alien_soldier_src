...
address audit registry contains 14,163 records. A further 2,179 provenance-mapped
...
upper bound is 1,666 names; no other pending `_End` labels are hidden by that
