...
- Naming/evidence rules, 13,267 provenance mappings, and the remaining 2,781
...
2,781 address-derived definitions intentionally remain in the unknowns backlog.
