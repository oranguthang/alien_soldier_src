...
- Naming/evidence rules, 15,963 provenance mappings, and the remaining 88
...
The contract does not require invented semantics. The 88 address-derived
...
audit registry contains 13,201 records. A further 3,062 provenance-mapped
