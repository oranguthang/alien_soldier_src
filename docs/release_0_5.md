...
- Naming/evidence rules, 16,019 provenance mappings, and the remaining 32
...
The contract does not require invented semantics. The 32 address-derived
...
audit registry contains 13,258 records. A further 3,061 provenance-mapped
