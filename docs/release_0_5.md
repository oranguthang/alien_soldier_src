...
address audit registry contains 13,426 records. A further 2,917 provenance-mapped
...
upper bound is 2,404 names; no other pending `_End` labels are hidden by that
