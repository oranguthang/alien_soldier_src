...
address audit registry contains 13,411 records. A further 2,932 provenance-mapped
...
upper bound is 2,419 names; no other pending `_End` labels are hidden by that
