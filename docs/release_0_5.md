...
- Naming/evidence rules, 15,908 provenance mappings, and the remaining 143
...
The contract does not require invented semantics. The 143 address-derived
...
audit registry contains 13,108 records. A further 3,100 provenance-mapped
