...
address audit registry contains 14,038 records. A further 2,304 provenance-mapped
...
upper bound is 1,791 names; no other pending `_End` labels are hidden by that
