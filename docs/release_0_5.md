...
- Naming/evidence rules, 12,463 provenance mappings, and the remaining 3,578
...
3,578 address-derived definitions intentionally remain in the unknowns backlog.
