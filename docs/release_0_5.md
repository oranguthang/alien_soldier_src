...
address audit registry contains 13,584 records. A further 2,758 provenance-mapped
...
upper bound is 2,245 names; no other pending `_End` labels are hidden by that
