...
- Naming/evidence rules, 15,941 provenance mappings, and the remaining 110
...
The contract does not require invented semantics. The 110 address-derived
...
audit registry contains 13,141 records. A further 3,100 provenance-mapped
