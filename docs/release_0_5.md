...
address audit registry contains 13,356 records. A further 2,987 provenance-mapped
...
upper bound is 2,474 names; no other pending `_End` labels are hidden by that
