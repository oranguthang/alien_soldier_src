...
- Naming/evidence rules, 15,451 provenance mappings, and the remaining 600
...
The contract does not require invented semantics. The 600 address-derived
...
audit registry contains 12,601 records. A further 3,150 provenance-mapped
