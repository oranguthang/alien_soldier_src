...
- Naming/evidence rules, 15,958 provenance mappings, and the remaining 93
...
The contract does not require invented semantics. The 93 address-derived
...
audit registry contains 13,163 records. A further 3,095 provenance-mapped
