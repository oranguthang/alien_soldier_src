...
address audit registry contains 13,755 records. A further 2,587 provenance-mapped
...
upper bound is 2,074 names; no other pending `_End` labels are hidden by that
