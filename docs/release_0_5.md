...
- Naming/evidence rules, 12,166 provenance mappings, and the remaining 3,875
...
3,875 address-derived definitions intentionally remain in the unknowns backlog.
