...
address audit registry contains 13,504 records. A further 2,838 provenance-mapped
...
upper bound is 2,325 names; no other pending `_End` labels are hidden by that
