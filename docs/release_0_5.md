...
- Naming/evidence rules, 12,098 provenance mappings, and the remaining 3,943
...
3,943 address-derived definitions intentionally remain in the unknowns backlog.
