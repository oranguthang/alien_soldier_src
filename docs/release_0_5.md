...
address audit registry contains 14,539 records. A further 1,803 provenance-mapped
...
upper bound is 1,290 names; no other pending `_End` labels are hidden by that
