...
- Naming/evidence rules, 15,833 provenance mappings, and the remaining 218
...
The contract does not require invented semantics. The 218 address-derived
...
audit registry contains 12,983 records. A further 3,150 provenance-mapped
