...
address audit registry contains 14,803 records. A further 1,539 provenance-mapped
...
upper bound is 1,026 names; no other pending `_End` labels are hidden by that
