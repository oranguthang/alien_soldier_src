...
address audit registry contains 13,515 records. A further 2,827 provenance-mapped
...
upper bound is 2,314 names; no other pending `_End` labels are hidden by that
