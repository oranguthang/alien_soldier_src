...
address audit registry contains 13,651 records. A further 2,691 provenance-mapped
...
upper bound is 2,178 names; no other pending `_End` labels are hidden by that
