...
address audit registry contains 13,527 records. A further 2,815 provenance-mapped
...
upper bound is 2,302 names; no other pending `_End` labels are hidden by that
