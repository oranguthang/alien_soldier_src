...
- Naming/evidence rules, 12,196 provenance mappings, and the remaining 3,845
...
- The listing exports 16,049 canonical ROM/RAM/hardware addresses; layout
...
3,845 address-derived definitions intentionally remain in the unknowns backlog.
