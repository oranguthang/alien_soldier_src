...
address audit registry contains 13,362 records. A further 2,981 provenance-mapped
...
upper bound is 2,468 names; no other pending `_End` labels are hidden by that
