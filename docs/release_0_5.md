...
- Naming/evidence rules, 12,438 provenance mappings, and the remaining 3,603
...
3,603 address-derived definitions intentionally remain in the unknowns backlog.
