...
address audit registry contains 14,343 records. A further 1,999 provenance-mapped
...
upper bound is 1,486 names; no other pending `_End` labels are hidden by that
