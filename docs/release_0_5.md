...
address audit registry contains 14,306 records. A further 2,036 provenance-mapped
...
upper bound is 1,523 names; no other pending `_End` labels are hidden by that
