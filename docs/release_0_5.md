...
address audit registry contains 14,457 records. A further 1,885 provenance-mapped
...
upper bound is 1,372 names; no other pending `_End` labels are hidden by that
