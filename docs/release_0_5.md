...
address audit registry contains 13,738 records. A further 2,604 provenance-mapped
...
upper bound is 2,091 names; no other pending `_End` labels are hidden by that
