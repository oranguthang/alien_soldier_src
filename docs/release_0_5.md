...
address audit registry contains 14,622 records. A further 1,720 provenance-mapped
...
upper bound is 1,207 names; no other pending `_End` labels are hidden by that
