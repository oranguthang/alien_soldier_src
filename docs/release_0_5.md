...
address audit registry contains 15,120 records. A further 1,222 provenance-mapped
...
upper bound is 709 names; no other pending `_End` labels are hidden by that
