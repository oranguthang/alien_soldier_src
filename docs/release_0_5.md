...
- Naming/evidence rules, 15,341 provenance mappings, and the remaining 710
...
The contract does not require invented semantics. The 710 address-derived
...
audit registry contains 12,471 records. A further 3,170 provenance-mapped
