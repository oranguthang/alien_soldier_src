...
- Naming/evidence rules, 15,250 provenance mappings, and the remaining 801
...
The contract does not require invented semantics. The 801 address-derived
...
audit registry contains 12,380 records. A further 3,170 provenance-mapped
