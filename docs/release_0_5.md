...
- Naming/evidence rules, 15,844 provenance mappings, and the remaining 207
...
The contract does not require invented semantics. The 207 address-derived
...
audit registry contains 13,001 records. A further 3,143 provenance-mapped
