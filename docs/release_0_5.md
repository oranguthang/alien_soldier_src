...
- Naming/evidence rules, 15,943 provenance mappings, and the remaining 108
...
The contract does not require invented semantics. The 108 address-derived
...
audit registry contains 13,147 records. A further 3,096 provenance-mapped
