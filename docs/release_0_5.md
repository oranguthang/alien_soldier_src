...
- Naming/evidence rules, 15,861 provenance mappings, and the remaining 190
...
The contract does not require invented semantics. The 190 address-derived
...
audit registry contains 13,040 records. A further 3,121 provenance-mapped
