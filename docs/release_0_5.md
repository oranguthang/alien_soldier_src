...
address audit registry contains 14,233 records. A further 2,109 provenance-mapped
...
upper bound is 1,596 names; no other pending `_End` labels are hidden by that
