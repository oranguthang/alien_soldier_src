...
address audit registry contains 13,335 records. A further 3,008 provenance-mapped
...
upper bound is 2,495 names; no other pending `_End` labels are hidden by that
