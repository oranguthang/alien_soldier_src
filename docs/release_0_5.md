...
address audit registry contains 14,498 records. A further 1,844 provenance-mapped
...
upper bound is 1,331 names; no other pending `_End` labels are hidden by that
