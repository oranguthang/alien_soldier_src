...
- Naming/evidence rules, 14,842 provenance mappings, and the remaining 1,209
...
The contract does not require invented semantics. The 1,209 address-derived
definitions in the current backlog comprise 831 RAM equates, 378 preserved-
data definitions, and no executable-source definitions. The exact-address
audit registry contains 12,069 records. A further 3,073 provenance-mapped
...
be folded into one record. It includes 382 reviewed asset `_End` aliases that
