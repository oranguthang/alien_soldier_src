...
- Naming/evidence rules, 13,379 provenance mappings, and the remaining 2,669
...
2,669 address-derived definitions intentionally remain in the unknowns backlog.
