...
address audit registry contains 13,938 records. A further 2,404 provenance-mapped
...
upper bound is 1,891 names; no other pending `_End` labels are hidden by that
