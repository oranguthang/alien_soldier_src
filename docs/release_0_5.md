...
address audit registry contains 13,831 records. A further 2,511 provenance-mapped
...
upper bound is 1,998 names; no other pending `_End` labels are hidden by that
