...
address audit registry contains 13,434 records. A further 2,909 provenance-mapped
...
upper bound is 2,396 names; no other pending `_End` labels are hidden by that
