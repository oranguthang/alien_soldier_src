...
- Naming/evidence rules, 12,860 provenance mappings, and the remaining 3,188
...
3,188 address-derived definitions intentionally remain in the unknowns backlog.
