...
- Naming/evidence rules, 13,310 provenance mappings, and the remaining 2,738
...
2,738 address-derived definitions intentionally remain in the unknowns backlog.
