...
address audit registry contains 13,724 records. A further 2,618 provenance-mapped
...
upper bound is 2,105 names; no other pending `_End` labels are hidden by that
