...
address audit registry contains 13,483 records. A further 2,859 provenance-mapped
...
upper bound is 2,346 names; no other pending `_End` labels are hidden by that
