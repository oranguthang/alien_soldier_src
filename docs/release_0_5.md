...
address audit registry contains 13,597 records. A further 2,745 provenance-mapped
...
upper bound is 2,232 names; no other pending `_End` labels are hidden by that
