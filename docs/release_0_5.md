...
- Naming/evidence rules, 15,983 provenance mappings, and the remaining 68
...
The contract does not require invented semantics. The 68 address-derived
...
audit registry contains 13,222 records. A further 3,061 provenance-mapped
