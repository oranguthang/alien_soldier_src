...
- Naming/evidence rules, 12,406 provenance mappings, and the remaining 3,635
...
3,635 address-derived definitions intentionally remain in the unknowns backlog.
