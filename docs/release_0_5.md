...
- Naming/evidence rules, 15,972 provenance mappings, and the remaining 79
...
The contract does not require invented semantics. The 79 address-derived
...
audit registry contains 13,211 records. A further 3,061 provenance-mapped
