...
address audit registry contains 13,462 records. A further 2,881 provenance-mapped
...
upper bound is 2,368 names; no other pending `_End` labels are hidden by that
