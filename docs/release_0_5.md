...
- Naming/evidence rules, 15,071 provenance mappings, and the remaining 980
...
The contract does not require invented semantics. The 980 address-derived
definitions in the current backlog comprise 831 RAM equates, 149 preserved-
data definitions, and no executable-source definitions. The exact-address
audit registry contains 12,253 records. A further 3,118 provenance-mapped
...
be folded into one record. It includes 434 reviewed asset `_End` aliases that
