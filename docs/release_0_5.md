...
address audit registry contains 14,755 records. A further 1,587 provenance-mapped
...
upper bound is 1,074 names; no other pending `_End` labels are hidden by that
