...
- Naming/evidence rules, 15,697 provenance mappings, and the remaining 354
...
The contract does not require invented semantics. The 354 address-derived
...
audit registry contains 12,847 records. A further 3,150 provenance-mapped
