...
- Naming/evidence rules, 16,000 provenance mappings, and the remaining 51
...
The contract does not require invented semantics. The 51 address-derived
...
audit registry contains 13,239 records. A further 3,061 provenance-mapped
