...
address audit registry contains 13,985 records. A further 2,357 provenance-mapped
...
upper bound is 1,844 names; no other pending `_End` labels are hidden by that
