...
address audit registry contains 13,313 records. A further 3,031 provenance-mapped
...
upper bound is 2,518 names; no other pending `_End` labels are hidden by that
