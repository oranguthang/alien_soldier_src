...
| `0x00D6D6-0x010025` | Flying Neo effects, later stage groups, boss transitions, and dispatch helpers | 13 | static/hypothesis |
...
| `0x016F36-0x0199F3` | player rendering, weapons, projectiles, and weapon UI | 7 | hypothesis |
| `0x0199F4-0x01C3F9` | player scripts, stage intros, Seven Forces states, object utilities, and projectile slots | 6 | hypothesis |
| `0x01C3FA-0x01E869` | gameplay entry states, main loop, debug helpers, plane shake, frontend, results, and transitions | 16 | static/hypothesis |
...
| `0x0537A8-0x05575D` | Missiray and Seven Forces projectile/introduction controller | 5 | hypothesis |
...
| `0x0E8000-0x0ED4B3` | frontend, player, enemy, projectile, and boss sprite mappings | 33 | hypothesis |
