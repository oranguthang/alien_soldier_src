...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 233 repeated-basis groups have exact-member reviews; 210 remain open. Seven
...
| `NAME-002` | Zero records match the curated 82-sentence generic detector; twenty-three repeated groups are accepted with exact members, and 210 remain open. | partial |
