...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Twenty-two of 241
  repeated-basis groups have exact-member reviews; 219 remain open. Seven
...
| `NAME-002` | Zero records match the curated 74-sentence generic detector; twenty-two repeated groups are accepted with exact members, and 219 remain open. | partial |
