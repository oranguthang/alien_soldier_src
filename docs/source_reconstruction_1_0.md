...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Twenty-five
  of 233 repeated-basis groups have exact-member reviews; 208 remain open. Seven
...
| `NAME-002` | Zero records match the curated 83-sentence generic detector; twenty-five repeated groups are accepted with exact members, and 208 remain open. | partial |
