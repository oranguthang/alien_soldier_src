...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. One of 248
  repeated-basis groups has an exact-member review; 247 remain open. Seven
...
| `NAME-002` | Zero records match the curated 58-sentence generic detector; one repeated group is accepted with exact members, and 247 remain open. | partial |
