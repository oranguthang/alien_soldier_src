...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Eighty-nine
  of 183 repeated-basis groups have exact-member reviews; 94 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; eighty-nine repeated groups are accepted with exact members, and 94 remain open. | partial |
