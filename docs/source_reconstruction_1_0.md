...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 237 repeated-basis groups have exact-member reviews; 214 remain open. Seven
...
| `NAME-002` | Zero records match the curated 78-sentence generic detector; twenty-three repeated groups are accepted with exact members, and 214 remain open. | partial |
