...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 224 repeated-basis groups have exact-member reviews; 187 remain open. Seven
...
| `NAME-002` | Zero records match the curated 93-sentence generic detector; thirty-seven repeated groups are accepted with exact members, and 187 remain open. | partial |
