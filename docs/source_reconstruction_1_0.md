...
- **Name evidence is traceable, with a declared review debt.**
  ...
  seven of 169 repeated-basis groups have exact-member reviews; 62 remain
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; one hundred seven repeated groups are accepted with exact members, and 62 remain open. | partial |
