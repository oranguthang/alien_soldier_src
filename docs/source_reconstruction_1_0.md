...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Sixty-eight
  of 201 repeated-basis groups have exact-member reviews; 133 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; sixty-eight repeated groups are accepted with exact members, and 133 remain open. | partial |
