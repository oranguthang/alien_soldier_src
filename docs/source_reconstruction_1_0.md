...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 209 repeated-basis groups have exact-member reviews; 157 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; fifty-two repeated groups are accepted with exact members, and 157 remain open. | partial |
