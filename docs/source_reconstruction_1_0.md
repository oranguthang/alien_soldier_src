...
- **Name evidence is traceable, with a declared review debt.**
  ...
  18 timer-return and 41 palette-fade records were then reviewed, leaving 398
...
| `NAME-002` | 398 records match the expanded 40-sentence generic detector; a further duplicate-basis review is pending. | partial |
