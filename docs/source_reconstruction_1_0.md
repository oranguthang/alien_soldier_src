...
- **Name evidence is traceable, with a declared review debt.**
  ...
  twenty-one of 169 repeated-basis groups have exact-member reviews; 48 remain
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; one hundred twenty-one repeated groups are accepted with exact members, and 48 remain open. | partial |
