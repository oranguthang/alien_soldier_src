...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 182 repeated-basis groups have exact-member reviews; 87 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; ninety-five repeated groups are accepted with exact members, and 87 remain open. | partial |
