...
- **Name evidence is traceable, with a declared review debt.**
  ...
  have been reviewed, as have 20 options-screen, 16 Jampan, 35 Sharpssteel, and
  43 Sirene, 45 Medusa, and 84 Valkirie records. Another 83 records match
  known generic evidence sentences
...
| `NAME-002` | 83 records still match known generic evidence sentences; a wider duplicate-basis review is also pending. | partial |
