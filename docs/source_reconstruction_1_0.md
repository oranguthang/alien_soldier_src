...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 225 repeated-basis groups have exact-member reviews; 188 remain open. Seven
...
| `NAME-002` | Zero records match the curated 92-sentence generic detector; thirty-seven repeated groups are accepted with exact members, and 188 remain open. | partial |
