...
- **Name evidence is traceable, with a declared review debt.**
  ...
  twenty-six of 165 repeated-basis groups have exact-member reviews; 39 remain
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; one hundred twenty-six repeated groups are accepted with exact members, and 39 remain open. | partial |
