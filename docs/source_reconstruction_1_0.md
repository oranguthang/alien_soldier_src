...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Forty-three
  of 219 repeated-basis groups have exact-member reviews; 176 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; forty-three repeated groups are accepted with exact members, and 176 remain open. | partial |
