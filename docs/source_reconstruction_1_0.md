...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Fifty-seven
  of 202 repeated-basis groups have exact-member reviews; 145 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; fifty-seven repeated groups are accepted with exact members, and 145 remain open. | partial |
