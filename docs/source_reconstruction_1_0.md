...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Six of 248
  repeated-basis groups have exact-member reviews; 242 remain open. Seven
...
| `NAME-002` | Zero records match the curated 60-sentence generic detector; six repeated groups are accepted with exact members, and 242 remain open. | partial |
