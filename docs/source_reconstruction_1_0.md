...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Eight of 247
  repeated-basis groups have exact-member reviews; 239 remain open. Seven
...
| `NAME-002` | Zero records match the curated 61-sentence generic detector; eight repeated groups are accepted with exact members, and 239 remain open. | partial |
