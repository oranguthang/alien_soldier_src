...
- **Name evidence is traceable, with a declared review debt.**
  ...
  fifteen of 169 repeated-basis groups have exact-member reviews; 54 remain
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; one hundred fifteen repeated groups are accepted with exact members, and 54 remain open. | partial |
