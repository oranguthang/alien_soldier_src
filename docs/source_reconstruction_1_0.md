...
- **Name evidence is traceable, with a declared review debt.**
  ...
  eleven of 169 repeated-basis groups have exact-member reviews; 58 remain
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; one hundred eleven repeated groups are accepted with exact members, and 58 remain open. | partial |
