...
- **Name evidence is traceable, with a declared review debt.**
  ...
  43 Sirene records. Another 212 records match known generic evidence sentences
...
| `NAME-002` | 212 records still match known generic evidence sentences; a wider duplicate-basis review is also pending. | partial |
