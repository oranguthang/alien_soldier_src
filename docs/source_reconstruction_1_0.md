...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 175 repeated-basis groups have exact-member reviews; 75 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; one hundred repeated groups are accepted with exact members, and 75 remain open. | partial |
