...
- **Name evidence is traceable, with a declared review debt.**
  ...
  twenty-one of 165 repeated-basis groups have exact-member reviews; 44 remain
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; one hundred twenty-one repeated groups are accepted with exact members, and 44 remain open. | partial |
