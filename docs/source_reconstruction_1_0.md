...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Sixty
  of 201 repeated-basis groups have exact-member reviews; 141 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; sixty repeated groups are accepted with exact members, and 141 remain open. | partial |
