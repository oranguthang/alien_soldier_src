...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 228 repeated-basis groups have exact-member reviews; 192 remain open. Seven
...
| `NAME-002` | Zero records match the curated 89-sentence generic detector; thirty-six repeated groups are accepted with exact members, and 192 remain open. | partial |
