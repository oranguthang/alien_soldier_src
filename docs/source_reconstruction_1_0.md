...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Eighteen of 240
  repeated-basis groups have exact-member reviews; 222 remain open. Seven
...
| `NAME-002` | Zero records match the curated 69-sentence generic detector; eighteen repeated groups are accepted with exact members, and 222 remain open. | partial |
