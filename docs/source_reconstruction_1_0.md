...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 236 repeated-basis groups have exact-member reviews; 213 remain open. Seven
...
| `NAME-002` | Zero records match the curated 79-sentence generic detector; twenty-three repeated groups are accepted with exact members, and 213 remain open. | partial |
