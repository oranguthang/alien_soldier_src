...
- **Name evidence is traceable, with a declared review debt.**
  ...
  two of 169 repeated-basis groups have exact-member reviews; 67 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; one hundred two repeated groups are accepted with exact members, and 67 remain open. | partial |
