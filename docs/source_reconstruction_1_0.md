...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Seventy-five
  of 194 repeated-basis groups have exact-member reviews; 119 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; seventy-five repeated groups are accepted with exact members, and 119 remain open. | partial |
