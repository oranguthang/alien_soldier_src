...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 220 repeated-basis groups have exact-member reviews; 178 remain open. Seven
...
| `NAME-002` | Zero records match the curated 97-sentence generic detector; forty-two repeated groups are accepted with exact members, and 178 remain open. | partial |
