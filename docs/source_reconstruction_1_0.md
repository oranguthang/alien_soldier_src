...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Eight of 246
  repeated-basis groups have exact-member reviews; 238 remain open. Seven
...
| `NAME-002` | Zero records match the curated 62-sentence generic detector; eight repeated groups are accepted with exact members, and 238 remain open. | partial |
