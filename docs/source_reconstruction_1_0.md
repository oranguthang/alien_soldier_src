...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Nine of 243
  repeated-basis groups have exact-member reviews; 234 remain open. Seven
...
| `NAME-002` | Zero records match the curated 65-sentence generic detector; nine repeated groups are accepted with exact members, and 234 remain open. | partial |
