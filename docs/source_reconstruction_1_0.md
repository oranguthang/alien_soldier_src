...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Thirty-six
  of 230 repeated-basis groups have exact-member reviews; 194 remain open. Seven
...
| `NAME-002` | Zero records match the curated 87-sentence generic detector; thirty-six repeated groups are accepted with exact members, and 194 remain open. | partial |
