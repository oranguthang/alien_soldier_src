...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Fourteen of 241
  repeated-basis groups have exact-member reviews; 227 remain open. Seven
...
| `NAME-002` | Zero records match the curated 67-sentence generic detector; fourteen repeated groups are accepted with exact members, and 227 remain open. | partial |
