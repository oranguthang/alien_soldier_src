...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Ninety-five
  of 177 repeated-basis groups have exact-member reviews; 82 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; ninety-five repeated groups are accepted with exact members, and 82 remain open. | partial |
