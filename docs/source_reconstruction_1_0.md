...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Thirty-three
  of 231 repeated-basis groups have exact-member reviews; 198 remain open. Seven
...
| `NAME-002` | Zero records match the curated 85-sentence generic detector; thirty-three repeated groups are accepted with exact members, and 198 remain open. | partial |
