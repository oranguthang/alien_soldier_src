...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Nineteen of 240
  repeated-basis groups have exact-member reviews; 221 remain open. Seven
...
| `NAME-002` | Zero records match the curated 70-sentence generic detector; nineteen repeated groups are accepted with exact members, and 221 remain open. | partial |
