...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Twenty-three
  of 235 repeated-basis groups have exact-member reviews; 212 remain open. Seven
...
| `NAME-002` | Zero records match the curated 80-sentence generic detector; twenty-three repeated groups are accepted with exact members, and 212 remain open. | partial |
