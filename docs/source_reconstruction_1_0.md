...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Seventeen of 240
  repeated-basis groups have exact-member reviews; 223 remain open. Seven
...
| `NAME-002` | Zero records match the curated 68-sentence generic detector; seventeen repeated groups are accepted with exact members, and 223 remain open. | partial |
