...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Eighty-eight
  of 186 repeated-basis groups have exact-member reviews; 98 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; eighty-eight repeated groups are accepted with exact members, and 98 remain open. | partial |
