...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Fifty-two
  of 213 repeated-basis groups have exact-member reviews; 161 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; fifty-two repeated groups are accepted with exact members, and 161 remain open. | partial |
