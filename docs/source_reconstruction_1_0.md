...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 202 repeated-basis groups have exact-member reviews; 148 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; fifty-four repeated groups are accepted with exact members, and 148 remain open. | partial |
