...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Thirty-eight
  of 222 repeated-basis groups have exact-member reviews; 184 remain open. Seven
...
| `NAME-002` | Zero records match the curated 95-sentence generic detector; thirty-eight repeated groups are accepted with exact members, and 184 remain open. | partial |
