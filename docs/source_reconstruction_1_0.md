...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 201 repeated-basis groups have exact-member reviews; 131 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; seventy repeated groups are accepted with exact members, and 131 remain open. | partial |
