...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Forty-two
  of 221 repeated-basis groups have exact-member reviews; 179 remain open. Seven
...
| `NAME-002` | Zero records match the curated 96-sentence generic detector; forty-two repeated groups are accepted with exact members, and 179 remain open. | partial |
