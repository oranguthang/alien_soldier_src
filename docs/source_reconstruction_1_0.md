...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Sixty-one
  of 201 repeated-basis groups have exact-member reviews; 140 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; sixty-one repeated groups are accepted with exact members, and 140 remain open. | partial |
