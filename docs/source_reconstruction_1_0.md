...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Twenty-seven
  of 233 repeated-basis groups have exact-member reviews; 206 remain open. Seven
...
| `NAME-002` | Zero records match the curated 83-sentence generic detector; twenty-seven repeated groups are accepted with exact members, and 206 remain open. | partial |
