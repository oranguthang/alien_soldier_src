...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Seven of 248
  repeated-basis groups have exact-member reviews; 241 remain open. Seven
...
| `NAME-002` | Zero records match the curated 60-sentence generic detector; seven repeated groups are accepted with exact members, and 241 remain open. | partial |
