...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Nine of 244
  repeated-basis groups have exact-member reviews; 235 remain open. Seven
...
| `NAME-002` | Zero records match the curated 64-sentence generic detector; nine repeated groups are accepted with exact members, and 235 remain open. | partial |
