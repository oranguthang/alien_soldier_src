...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Thirty-seven
  of 227 repeated-basis groups have exact-member reviews; 190 remain open. Seven
...
| `NAME-002` | Zero records match the curated 90-sentence generic detector; thirty-seven repeated groups are accepted with exact members, and 190 remain open. | partial |
