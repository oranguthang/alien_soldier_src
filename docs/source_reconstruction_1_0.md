...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 213 repeated-basis groups have exact-member reviews; 163 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; fifty repeated groups are accepted with exact members, and 163 remain open. | partial |
