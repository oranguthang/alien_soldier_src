...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 222 repeated-basis groups have exact-member reviews; 181 remain open. Seven
...
| `NAME-002` | Zero records match the curated 95-sentence generic detector; forty-one repeated groups are accepted with exact members, and 181 remain open. | partial |
