...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Seven of 247
  repeated-basis groups have exact-member reviews; 240 remain open. Seven
...
| `NAME-002` | Zero records match the curated 61-sentence generic detector; seven repeated groups are accepted with exact members, and 240 remain open. | partial |
