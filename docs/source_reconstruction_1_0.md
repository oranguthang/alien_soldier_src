...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Fifteen of 241
  repeated-basis groups have exact-member reviews; 226 remain open. Seven
...
| `NAME-002` | Zero records match the curated 67-sentence generic detector; fifteen repeated groups are accepted with exact members, and 226 remain open. | partial |
