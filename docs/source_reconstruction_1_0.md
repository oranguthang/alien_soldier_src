...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Twenty-eight
  of 231 repeated-basis groups have exact-member reviews; 203 remain open. Seven
...
| `NAME-002` | Zero records match the curated 85-sentence generic detector; twenty-eight repeated groups are accepted with exact members, and 203 remain open. | partial |
