...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 191 repeated-basis groups have exact-member reviews; 115 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; seventy-six repeated groups are accepted with exact members, and 115 remain open. | partial |
