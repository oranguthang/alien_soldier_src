...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Nine of 245
  repeated-basis groups have exact-member reviews; 236 remain open. Seven
...
| `NAME-002` | Zero records match the curated 63-sentence generic detector; nine repeated groups are accepted with exact members, and 236 remain open. | partial |
