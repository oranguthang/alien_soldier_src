...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 233 repeated-basis groups have exact-member reviews; 205 remain open. Seven
...
| `NAME-002` | Zero records match the curated 83-sentence generic detector; twenty-eight repeated groups are accepted with exact members, and 205 remain open. | partial |
