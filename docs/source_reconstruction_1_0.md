...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Forty-five
  of 219 repeated-basis groups have exact-member reviews; 174 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; forty-five repeated groups are accepted with exact members, and 174 remain open. | partial |
