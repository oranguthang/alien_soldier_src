...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 240 repeated-basis groups have exact-member reviews; 217 remain open. Seven
...
| `NAME-002` | Zero records match the curated 75-sentence generic detector; twenty-three repeated groups are accepted with exact members, and 217 remain open. | partial |
