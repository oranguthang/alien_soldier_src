...
- **Name evidence is traceable, with a declared review debt.**
  ...
  43 Sirene and 45 Medusa records. Another 167 records match known generic
  evidence sentences
...
| `NAME-002` | 167 records still match known generic evidence sentences; a wider duplicate-basis review is also pending. | partial |
