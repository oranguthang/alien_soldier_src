...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 231 repeated-basis groups have exact-member reviews; 195 remain open. Seven
...
| `NAME-002` | Zero records match the curated 86-sentence generic detector; thirty-six repeated groups are accepted with exact members, and 195 remain open. | partial |
