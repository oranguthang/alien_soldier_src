...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Seventy-six
  of 186 repeated-basis groups have exact-member reviews; 110 remain open. Seven
...
| `NAME-002` | Zero records match the curated 98-sentence generic detector; seventy-six repeated groups are accepted with exact members, and 110 remain open. | partial |
