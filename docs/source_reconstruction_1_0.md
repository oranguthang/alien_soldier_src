...
- **Name evidence is traceable, with a declared review debt.**
  ...
  43 Sirene, 45 Medusa, 84 Valkirie, and 15 graphics/asset records. Another 68
...
| `NAME-002` | 68 records still match known generic evidence sentences; a wider duplicate-basis review is also pending. | partial |
