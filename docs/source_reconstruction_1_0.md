...
- **Name evidence is traceable, with a declared review debt.**
  ...
  then reviewed. The curated `NAME-002` detector has zero matches. Fifteen of 240
  repeated-basis groups have exact-member reviews; 225 remain open. Seven
...
| `NAME-002` | Zero records match the curated 68-sentence generic detector; fifteen repeated groups are accepted with exact members, and 225 remain open. | partial |
