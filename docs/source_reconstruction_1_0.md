...
- **Name evidence is traceable, with a declared review debt.**
  ...
  of 224 repeated-basis groups have exact-member reviews; 186 remain open. Seven
...
| `NAME-002` | Zero records match the curated 93-sentence generic detector; thirty-eight repeated groups are accepted with exact members, and 186 remain open. | partial |
