...
At the start of release 0.5 work the source contains 10,497 defined symbols
...
work should reduce the count. It is not a target that must reach zero for the
