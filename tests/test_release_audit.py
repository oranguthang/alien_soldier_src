...
class ReleaseAuditTests(unittest.TestCase):
    ...
    def test_provenance_blocks_tag_ready_status_after_name_review(self) -> None:
        manifest = self._manifest()
        ...
        self.assertFalse(any("hypothesis-level name records" in error for error in errors))
